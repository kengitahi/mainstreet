...
export default function Home() {
  return (
    <main className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto my-16">
      <div className="my-20 hero">
        <div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <PrimaryBtnLink text="Start Your Digital Journey" href="#">
              <svg class="w-6 h-6 text-currentColor dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <div class="relative">
          <Image src={heroImg3} alt="web development office" style={{ position: 'absolute', marginTop: '0%', maxWidth: '90%', height: 'auto', right: 0 }} className='rounded-lg' />
          <div>
            <div className='w-1/2 h-full'></div>
            <Image src={heroImg1} alt="web developer sitting at a desk" style={{ position: 'absolute', marginTop: '10%' }} className='rounded-lg' />
          </div>
