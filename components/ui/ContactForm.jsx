...
00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                ...
                <span className="font-medium">
                  Success! Thank you so much, your message has been sent
                  successfully.
                </span>
              </div>
              <span className="font-medium">
                We will get back to you shortly (typically within a few hours).
              </span>
            </div>
          </div>
        )}
...
0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                ...
                <span className="font-medium">
                  There was an issue sending the form. Please try again.
                </span>
              </div>
            </div>
          </div>
