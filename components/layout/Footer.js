    ...
    return (
        <footer className="p-4 mt-16 bg-white md:p-8 lg:p-10 dark:bg-gray-800 shadow-t-lg font-inter">
            <div className="mx-auto max-w-screen-xl text-center">
                ...
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">MainStreet Digital</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
